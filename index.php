...
<html>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
           <div class="container">
               <a class="navbar-brand js-scroll-trigger" href="#page-top">DreamRent</a>
               ...
               <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <?php /*show login and home only if not logged*/
        ...
        <header class=masthead>
            <div class="container">
                <div class="intro-text">
                    <div class="intro-lead-in">Welcome To DreamRent!</div>
                    <div class="intro-heading text-uppercase">Find your next home!<br></div>
                </div>
            </div>
        </header>
        ...
        <div class="container">
            <div class="row">
            <div class="col-md-4">
                <span class="copyright">Copyright &copy; Tehnologii Web Proiect 2022</span>
            </div>
            <div class="col-md-4">
                <ul class="list-inline social-buttons">
                <li class="list-inline-item">
                    <a href="https://www.instagram.com/stefan_jse/">
                    <i class="fa fa-instagram"></i>
                    </a>
                </li>
                <li class="list-inline-item">
                    <a href="https://www.facebook.com/cornel.joita.5">
